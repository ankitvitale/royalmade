...
public interface MaterialRepository extends JpaRepository<Material,Long> {
    List<Material> findByVendorId(Long id);

    List<Material> findByProjectId(Long projectId);

    Optional<Material> findTopByVendorIdOrderByDateDesc(Long vendorId);
    Optional<Material> findTopByProjectIdOrderByDateDesc(Long projectId);
